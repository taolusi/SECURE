...
parser.add_argument(
    ...
    default="data/ecb+/raw/ECB+_LREC2014/ECB+",
)
parser.add_argument(
    "--output_dir",
    type=str,
    help="The directory of the output files",
    default="data/ecb+/interim",
)
parser.add_argument(
    "--data_setup",
    type=int,
    help="Set the desirable dataset setup, 1 for Yang/Choubey setup and 2 for Cybulska/Kenyon-Dean setup (recommended as used in our experiments)",
    default=2,
)
parser.add_argument(
    ...
    default="data/ecb+/raw/ECB+_LREC2014/ECBplus_coreference_sentences.csv",
)
